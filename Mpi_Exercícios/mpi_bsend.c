...
int tam_buffer=1;
int destino, recebido[TAM], etiq=1, cont=tam_buffer;
MPI_Status estado;
void *buffer;
    ...
    MPI_Pack_size(TAM, MPI_BYTE, MPI_COMM_WORLD, &tam_buffer);
    ...
    MPI_Bsend(&reducao, cont, MPI_BYTE, destino, etiq, MPI_COMM_WORLD);
